    ...
    def publish_node_birth(self, client):
        ...
        payload.metrics.extend(
            [
                ...
                create_metric("Node Metric0", None, DataType.String, "hello node"),
                create_metric("Node Metric1", None, DataType.Boolean, True),
                create_metric("Node Metric3", None, DataType.Int32, None),
